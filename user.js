! function (e) {
    ...
    function Tn() {
        I("gayname", Le.value), !le && r.connected && (le = !0, x.stop("menu"), dt("Loading..."), r.send("sp", {
            name: Le.value,
            moofoll: true,
            skin: ae
        }))
    ...
    function ri(e, t) {
        ...
        if (!n || t) {
            ...
            if (r.translate(i.width / 2, i.height / 2), r.rotate(t ? 0 : Math.PI / 2), r.strokeStyle = it, r.lineWidth = 5.5 * (t ? i.width / 81 : 1), "apple" == e.name) {
                r.fillStyle = color, si(0, 0, e.scale, r), r.fillStyle = "#89a54c";
                var a = -Math.PI / 2;
                ! function (e, t, n, i, r) {
        ...
        function e() {
            B = Date.now(), P = B - q, q = B,
                function () {
                    ...
                    for (be.globalAlpha = 1, be.fillStyle = "rgba(0, 0, 70, 0.35)", be.fillRect(0, 0, oe, ce), be.strokeStyle = rt, a = 0; a < W.length + Y.length; ++a)
                        if ((_ = W[a] || Y[a - W.length]).visible && (10 != _.skinIndex || _ == R || _.team && _.team == R.team)) {
                            var w = (_.team ? "[" + _.team + "] " : "")  + (_.isPlayer&&_.sid? "[" +  _.sid + "] " : "") + (_.name || "");
                            if ("" != w) {
                ...
                var color = '#' + r1213.toString(16) + g1213.toString(16) + b1213.toString(16);
                            ...
                            be.textAlign = "center",
                            be.lineWidth = _.nameScale ? 100 : 8,
                            be.lineJoin = "round",
                            be.strokeStyle = "#000000",
                            be.strokeText("✮" ,(R.x-f + _.x-f)/2,(R.y-d +_.y-d)/2),
                            be.fillText("✮" ,(R.x-f + _.x-f)/2,(R.y-d +_.y-d)/2)
                            }

                            _.health > 0 && (o.healthBarWidth, be.fillStyle = rt, be.roundRect(_.x - f - o.healthBarWidth - o.healthBarPad, _.y - d + _.scale + o.nameY, 2 * o.healthBarWidth + 2 * o.healthBarPad, 17, 8), be.fill(), be.fillStyle = _ == R || _.team && _.team == R.team ? color : "#cc5151", be.roundRect(_.x - f - o.healthBarWidth, _.y - d + _.scale + o.nameY + o.healthBarPad, 2 * o.healthBarWidth * (_.health / _.maxHealth), 17 - 2 * o.healthBarPad, 7), be.fill())
